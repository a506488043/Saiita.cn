 ...
 %>
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-files-o"></i>
					<span>用户管理</span> <span class="pull-right-container"> <span
						class="label label-primary pull-right">2</span>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="pages/tables/data.jsp" target="mainFrame"><i
							class="fa fa-circle-o"></i> 用户信息</a></li>
					<li><a href="pages/tables/editordata.jsp" target="mainFrame"><i
							class="fa fa-circle-o"></i> 编辑用户</a></li>
				</ul></li>
			<li class="treeview"><a href="#"> <i class="fa fa-th"></i> <span>收入支出账单</span>
				...
				<ul class="treeview-menu">
					...
					<li><a href="pages/tables/creditCard.jsp"
		...
		<footer class="main-footer"> <strong>Copyright
			&copy; 2017-3017 <a href="http://almsaeedstudio.com">Almsaeed
				Studio</a>.
